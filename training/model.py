...
# ═══════════════════════════════════════════════════════════════════════════
# V5: Imported from training/models/ — kept here for backward compatibility
#
# NOTE: actor_critic_v5 imports AbilityTransformer/CrossAttentionBlock from
# this file, so we must import it AFTER those classes are defined above.
# The other V5 modules have no circular dependency.
# ═══════════════════════════════════════════════════════════════════════════
...
from models.encoder_v5 import EntityEncoderV5, AGG_FEATURE_DIM, NUM_V5_TYPES, V5_DEFAULT_D, V5_DEFAULT_HEADS  # noqa: F811,E402
from models.latent_interface import LatentInterface  # noqa: E402
from models.cfc_cell import CfCCell, CFC_H_DIM  # noqa: F811,E402
from models.combat_head import CombatPointerHeadV5  # noqa: E402

# Import actor_critic_v5 DIRECTLY (not through models/__init__) to avoid circular import
from models.actor_critic_v5 import AbilityActorCriticV5, V5_DEFAULT_LATENTS  # noqa: E402
