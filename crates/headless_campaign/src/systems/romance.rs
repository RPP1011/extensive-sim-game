...
use crate::systems::bonds::{bond_key, bond_strength};
                ...
                RomanceStage::BrokenUp => {
                    ...
                    if roll < 0.30 {
                        ...
                        if !super::rivalries::has_rivalry(state, lo, hi) {
                            state.rivalries.push(crate::state::Rivalry {
                                adventurer_a: lo,
                                adventurer_b: hi,
                                intensity: 20.0,
                                cause: crate::state::RivalryCause::PersonalInsult,
                                started_tick: tick,
                            });
                        }
                    }
...
pub fn on_partner_died(state: &mut CampaignState, dead_id: u32, _events: &mut Vec<WorldEvent>) {
