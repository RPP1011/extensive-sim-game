...
use crate::sim::{distance, can_see, can_see_with_nav, SimState, UnitState};

use crate::squad::personality::Personality;
use crate::squad::state::{SquadBlackboard, TickContext};

pub(in crate::squad) fn choose_target(
    state: &SimState,
    unit_id: u32,
