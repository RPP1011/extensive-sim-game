...
use crate::sim::{SimState, SimVec2, Team, UnitIntent, UnitState};
use crate::phase::AiPhase;
...
impl SquadAiState {
    ...
    pub fn new_from_roles(
        initial: &SimState,
        roles: HashMap<u32, crate::roles::Role>,
    ) -> Self {
...
pub(super) fn role_to_personality(role: crate::roles::Role) -> Personality {
