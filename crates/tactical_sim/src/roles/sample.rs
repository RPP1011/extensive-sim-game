...
pub fn sample_phase2_party_state(seed: u64) -> SimState {
    ...
    state.units = UnitStore::new(vec![
        crate::sim::UnitState {
            ...
            hp: 145,
            max_hp: 145,
            position: crate::sim::sim_vec2(-2.0, -1.0),
        ...
        crate::sim::UnitState {
            ...
            hp: 98,
            max_hp: 98,
            position: crate::sim::sim_vec2(-4.0, 0.2),
        ...
        crate::sim::UnitState {
            ...
            hp: 92,
            max_hp: 92,
            position: crate::sim::sim_vec2(-5.5, 1.0),
        ...
        crate::sim::UnitState {
            ...
            hp: 142,
            max_hp: 142,
            position: crate::sim::sim_vec2(8.0, -1.0),
        ...
        crate::sim::UnitState {
            ...
            hp: 96,
            max_hp: 96,
            position: crate::sim::sim_vec2(10.0, 0.2),
        ...
        crate::sim::UnitState {
            ...
            hp: 94,
            max_hp: 94,
            position: crate::sim::sim_vec2(11.5, 1.0),
