...
mod tests_stress {
    ...
    use crate::sim::*;
    use crate::sim::determinism::hash_sim_state;
    use crate::effects::{
    ...
    use crate::squad::{self as squad_ai, SquadAiState};
        ...
        match id % 4 {
            0 => {
                u.abilities.push(AbilitySlot::new(AbilityDef {
                    ...
                    effects: vec![ConditionalEffect {
                        ...
                        tags: HashMap::new(), stacking: Stacking::default(), chance: 0.0, else_effects: vec![], targeting_filter: None,
                    }],
                ...
                u.passives.push(PassiveSlot::new(PassiveDef {
                    ...
                    effects: vec![ConditionalEffect {
                        ...
                        condition: None, area: None, tags: HashMap::new(), stacking: Stacking::default(), chance: 0.0, else_effects: vec![], targeting_filter: None,
                    }],
                    range: 0.0,
                }));
            }
            ...
            3 | _ => {
                ...
                u.abilities.push(AbilitySlot::new(AbilityDef {
                    ...
                    effects: vec![
                        ConditionalEffect { effect: Effect::Stun { duration_ms: 1200 }, condition: None, area: None, tags: HashMap::new(), stacking: Stacking::default(), chance: 0.0, else_effects: vec![], targeting_filter: None },
                        ConditionalEffect {
