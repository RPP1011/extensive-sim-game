...
pub struct CastState {
    ...
    #[serde(default)]
    pub area: Option<crate::effects::Area>,
...
impl CastEffectHint {
    ...
    pub fn from_ability_def(def: &crate::effects::AbilityDef) -> Self {
        ...
        for ce in &def.effects {
            match &ce.effect {
                crate::effects::Effect::Damage { .. } => has_damage = true,
                crate::effects::Effect::Heal { .. } => has_heal = true,
                crate::effects::Effect::Stun { .. }
                | crate::effects::Effect::Slow { .. }
                | crate::effects::Effect::Root { .. }
                | crate::effects::Effect::Knockback { .. }
                | crate::effects::Effect::Pull { .. }
                | crate::effects::Effect::Silence { .. }
                | crate::effects::Effect::Polymorph { .. }
                | crate::effects::Effect::Fear { .. }
                | crate::effects::Effect::Grounded { .. }
                | crate::effects::Effect::Suppress { .. } => has_cc = true,
                crate::effects::Effect::Obstacle { .. } => has_obstacle = true,
                crate::effects::Effect::Shield { .. }
                | crate::effects::Effect::Buff { .. }
                | crate::effects::Effect::Stealth { .. } => has_buff = true,
                crate::effects::Effect::Summon { .. } => has_summon = true,
                _ => {}
            }
        }
...
pub struct SimState {
    ...
    #[serde(skip, default)]
    pub grid_nav: Option<crate::pathing::GridNav>,
}
