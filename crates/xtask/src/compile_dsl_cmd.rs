...
fn cs_spatial_engagement_query(@builtin(global_invocation_id) gid: vec3<u32>) {\n\
    ...
    let _c = cfg.agent_cap;\n\
        ...
        // T16 hoists the real bodies into the emit path).
        {
            ...
            // declarations live. T16 hoists the real ALIVE_PACK_WGSL.
            let alive_wgsl = "// GENERATED by dsl_compiler. Do not edit by hand.\n\
@group(0) @binding(0) var<storage, read> agents: array<u32>;\n\
...
fn cs_fused_agent_unpack(@builtin(global_invocation_id) gid: vec3<u32>) {\n\
    ...
    let _c = cfg.agent_cap;\n\
        ...
        // default) for the same reason.
        {
            ...
            let apply_wgsl = "// GENERATED by dsl_compiler. Do not edit by hand.\n\
...
fn cs_apply_actions(@builtin(global_invocation_id) gid: vec3<u32>) {\n\
    ...
    let _g = cfg.tick;\n\
        ...
        // appends the FixedPoint entry pointing at Physics.
        {
            ...
            let movement_wgsl = "// GENERATED by dsl_compiler. Do not edit by hand.\n\
@group(0) @binding(0) var<storage, read_write> agents: array<u32>;\n\
...
fn cs_physics(@builtin(global_invocation_id) gid: vec3<u32>) {\n\
    ...
    let _c = cfg.iter_idx;\n\
            ...
            let seed_wgsl = "// GENERATED by dsl_compiler. Do not edit by hand.\n\
...
fn cs_seed_indirect(@builtin(global_invocation_id) gid: vec3<u32>) {\n\
    ...
    let _c = cfg.iter_idx;\n\
            ...
            let append_wgsl = "// GENERATED by dsl_compiler. Do not edit by hand.\n\
    ...
    let _c = cfg.source_capacity;\n\
            ...
            Vec::new();
        {
            ...
            for v in &combined.views {
                ...
                // No-op WGSL stub matching the emitted BGL slot-for-slot
                // (event_ring @ 0, event_tail @ 1, view_storage_primary
                // @ 2, view_storage_anchor @ 3, view_storage_ids @ 4,
                // sim_cfg @ 5, cfg @ 6). Each binding is touched once
                // with a no-op read so naga keeps the declarations
                // live; T16 hoists a real body produced by
                // `emit_view_wgsl::emit_view_fold_wgsl` (or its
                // shape-dedicated siblings for symmetric_pair_topk /
                // per_entity_ring) wrapped in a `cs_fold_<view>` entry
                // point that walks the event ring.
                let wgsl = format!(
                    "// GENERATED by dsl_compiler. Do not edit by hand.\n\
