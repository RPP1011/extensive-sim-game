...
impl TomProbeState {
    ...
    pub fn erase_belief(&mut self, caster: u32, target: u32, subject_idx: u32, fields: u8) {
        ...
        let cfg = physics_ApplyEraseBeliefUpdate::PhysicsApplyEraseBeliefUpdateCfg {
            event_count: 1,
            tick: self.tick as u32,
            seed: self.seed as u32,
            agent_cap: self.agent_count,
        ...
        let bindings = physics_ApplyEraseBeliefUpdate::PhysicsApplyEraseBeliefUpdateBindings {
            event_ring: self.event_ring.ring(),
            event_tail: self.event_ring.tail(),
            beliefs_pos: &self.beliefs_pos_primary,
            beliefs_type: &self.beliefs_type_primary,
        ...
        dispatch::dispatch_physics_applyerasebeliefupdate(
            &mut self.cache,
            &bindings,
            &self.gpu.device,
            &mut encoder,
