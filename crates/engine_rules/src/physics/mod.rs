...
pub fn dispatch_agent_attacked(
    event: &Event,
    state: &mut SimState,
...
#[allow(unused_variables)]
pub fn dispatch_effect_damage_applied(
    event: &Event,
    state: &mut SimState,
    views: &mut ViewRegistry,
    events: &mut EventRing<Event>,
...
#[allow(unused_variables)]
pub fn dispatch_effect_gold_transfer(
    event: &Event,
    state: &mut SimState,
    views: &mut ViewRegistry,
    events: &mut EventRing<Event>,
...
#[allow(unused_variables)]
pub fn dispatch_effect_heal_applied(
    event: &Event,
    state: &mut SimState,
    views: &mut ViewRegistry,
    events: &mut EventRing<Event>,
...
#[allow(unused_variables)]
pub fn dispatch_effect_shield_applied(
    event: &Event,
    state: &mut SimState,
    views: &mut ViewRegistry,
    events: &mut EventRing<Event>,
...
#[allow(unused_variables)]
pub fn dispatch_effect_slow_applied(
    event: &Event,
    state: &mut SimState,
    views: &mut ViewRegistry,
    events: &mut EventRing<Event>,
...
#[allow(unused_variables)]
pub fn dispatch_effect_standing_delta(
    event: &Event,
    state: &mut SimState,
    views: &mut ViewRegistry,
    events: &mut EventRing<Event>,
...
#[allow(unused_variables)]
pub fn dispatch_effect_stun_applied(
    event: &Event,
    state: &mut SimState,
    views: &mut ViewRegistry,
    events: &mut EventRing<Event>,
...
#[allow(unused_variables)]
pub fn dispatch_engagement_broken(
    event: &Event,
    state: &mut SimState,
    views: &mut ViewRegistry,
    events: &mut EventRing<Event>,
...
#[allow(unused_variables)]
pub fn dispatch_engagement_committed(
    event: &Event,
    state: &mut SimState,
    views: &mut ViewRegistry,
    events: &mut EventRing<Event>,
