...
struct FoldPackFocusCfg { event_count: u32, tick: u32, _pad0: u32, _pad1: u32 };
@group(0) @binding(6) var<uniform> cfg: FoldPackFocusCfg;
@compute @workgroup_size(64)
fn cs_fold_pack_focus(@builtin(global_invocation_id) gid: vec3<u32>) {
