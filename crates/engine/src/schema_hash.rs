...
pub fn schema_hash() -> [u8; 32] {
    ...
    h.update(b"EffectOp:Damage=0{amount=f32},Heal=1{amount=f32},Shield=2{amount=f32},Stun=3{duration_ticks=u32},Slow=4{duration_ticks=u32,factor_q8=i16},TransferGold=5{amount=i32},ModifyStanding=6{delta=i16},CastAbility=7{ability=AbilityId,selector=TargetSelector},Root=8{duration_ticks=u32},Silence=9{duration_ticks=u32},Fear=10{duration_ticks=u32},Taunt=11{duration_ticks=u32},Dash=12{distance=f32},Blink=13{distance=f32},Knockback=14{distance=f32},Pull=15{distance=f32}");
