...
pub fn schema_hash() -> [u8; 32] {
    ...
    h.update(b"Event:AgentMoved,AgentAttacked,AgentDied,AgentFled,ChronicleEntry");
    ...
    h.update(b"EventKindId:AgentMoved=0,AgentAttacked=1,AgentDied=2,AgentFled=3,ChronicleEntry=128");
