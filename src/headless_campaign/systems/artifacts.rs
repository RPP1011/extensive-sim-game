...
use crate::headless_campaign::state::{
    AdventurerStatus, Artifact, ArtifactEffect, ArtifactStats, CampaignState, EquipmentSlot,
    lcg_f32, lcg_next,
};
...
fn best_equipment_slot(equipment: &crate::headless_campaign::state::Equipment) -> &'static str {
