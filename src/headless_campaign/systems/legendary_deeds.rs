...
use crate::headless_campaign::state::{AdventurerStatus, CampaignState, DeedType};
...
pub fn tick_legendary_deeds(
    ...
    let mut grants: Vec<(usize, DeedType, String, String, crate::headless_campaign::state::DeedBonus)> = Vec::new();
    ...
    for (idx, adv) in state.adventurers.iter().enumerate() {
        ...
        if kill_count > 10 && !has_deed(&adv.deeds, &DeedType::Slayer) {
            grants.push((
                ...
                crate::headless_campaign::state::DeedBonus::CombatPowerBoost(0.05),
            ));
        }
        ...
        if diplo_count > 5 && !has_deed(&adv.deeds, &DeedType::Peacemaker) {
            grants.push((
                ...
                crate::headless_campaign::state::DeedBonus::FactionRelationBoost(10.0),
            ));
        }
        ...
        if explore_count > 8 && !has_deed(&adv.deeds, &DeedType::Explorer) {
            grants.push((
                ...
                crate::headless_campaign::state::DeedBonus::QuestRewardBoost(0.15),
            ));
        }
        ...
        if near_death > 3 && !has_deed(&adv.deeds, &DeedType::Survivor) {
            grants.push((
                ...
                crate::headless_campaign::state::DeedBonus::MoraleAura(0.10),
            ));
        }
        ...
        if quest_count > 15 && !has_deed(&adv.deeds, &DeedType::Wealthy) {
            grants.push((
                ...
                crate::headless_campaign::state::DeedBonus::QuestRewardBoost(0.20),
            ));
        }
        ...
        if solo_count > 5 && !has_deed(&adv.deeds, &DeedType::Undefeated) {
            grants.push((
                ...
                crate::headless_campaign::state::DeedBonus::CombatPowerBoost(0.10),
            ));
        }
        ...
        if defense_count > 5 && !has_deed(&adv.deeds, &DeedType::Defender) {
            grants.push((
                ...
                crate::headless_campaign::state::DeedBonus::RecruitmentBoost(0.10),
            ));
        }
        ...
        if rescue_count > 5 && !has_deed(&adv.deeds, &DeedType::Savior) {
            grants.push((
                ...
                crate::headless_campaign::state::DeedBonus::FactionRelationBoost(5.0),
            ));
        }
    }
    ...
    for (idx, deed_type, title, description, bonus) in grants {
        ...
        adv.deeds.push(crate::headless_campaign::state::LegendaryDeed {
            title: title.clone(),
            earned_at_tick: tick,
            deed_type,
            bonus,
...
fn has_deed(deeds: &[crate::headless_campaign::state::LegendaryDeed], dtype: &DeedType) -> bool {
