...
pub mod action_sync;
pub mod world_goap;
pub mod social_gathering;
pub mod adventuring;
pub mod interiors;
pub mod death_consequences;
pub mod sea_travel;
pub mod family;
pub mod betrayal;
pub mod trade_guilds;
pub mod outlaws;
pub mod prophecy;
pub mod legends;
pub mod succession;
...
pub fn compute_global_systems(state: &WorldState, out: &mut Vec<WorldDelta>) {
    ...
    run_system!("nemesis", nemesis::compute_nemesis, state, out);
    run_system!("threat", threat::compute_threat, state, out);
    run_system!("threat_clock", threat_clock::compute_threat_clock, state, out);
    ...
    run_system!("culture", culture::compute_culture, state, out);
