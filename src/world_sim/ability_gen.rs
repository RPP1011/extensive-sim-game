...
fn profile_for_archetype(archetype: &str) -> ArchetypeProfile {
    match archetype {
        ...
        // --- Non-combat archetypes: economy, diplomacy, leadership, etc. ---
        "merchant" | "trader" | "banker" | "smuggler" => ArchetypeProfile {
            passive_chance: 0.5,
            targeting: [1.0, 1.0, 3.0, 0.5, 0.5, 0.3],
            range: [3.0, 6.0],
            cooldown: [10000, 30000],
            hint: [0.3, 0.3, 0.5, 4.0, 0.3],
            delivery: [3.0, 0.5, 0.5, 0.5, 0.3, 0.5, 0.3],
            //          dmg  heal shld stun root sil  slw  kb   dash buff debf sum  stlh ls   exec res  misc
            //          |--- combat (17) ---|----------------------------------------------|--- campaign (7) ---|
            effect_weights: [0.3, 0.2, 0.3, 0.2, 0.1, 0.1, 0.1, 0.1, 0.2, 1.0, 0.5, 0.1, 0.3, 0.1, 0.1, 0.1, 0.2,
                             0.5, 3.0, 2.0, 0.5, 1.5, 0.5, 3.0],
            second_effect_chance: 0.3,
            area_chance: 0.15,
            trigger: [0.5, 0.5, 0.3, 0.5, 0.5, 3.0],
        },
        "scholar" | "sage" | "researcher" | "librarian" => ArchetypeProfile {
            passive_chance: 0.5,
            targeting: [0.5, 1.5, 3.0, 1.0, 0.5, 0.3],
            range: [4.0, 7.0],
            cooldown: [10000, 25000],
            hint: [0.3, 0.3, 0.3, 4.0, 0.5],
            delivery: [3.0, 0.3, 1.0, 0.5, 0.3, 0.3, 0.3],
            effect_weights: [0.3, 0.3, 0.5, 0.2, 0.2, 0.5, 0.2, 0.1, 0.1, 2.0, 0.5, 0.3, 0.1, 0.1, 0.1, 0.1, 0.5,
                             0.3, 0.5, 1.5, 3.0, 1.5, 0.3, 1.0],
            second_effect_chance: 0.4,
            area_chance: 0.2,
            trigger: [0.3, 0.5, 0.3, 2.0, 0.5, 2.0],
        },
        "farmer" | "miner" | "woodsman" | "artisan" | "smith" | "brewer" | "cook" => ArchetypeProfile {
            passive_chance: 0.6,
            targeting: [0.5, 1.0, 3.0, 0.5, 0.3, 0.3],
            range: [1.5, 4.0],
            cooldown: [12000, 30000],
            hint: [0.3, 0.3, 1.0, 3.0, 0.5],
            delivery: [3.0, 0.3, 0.5, 0.5, 0.3, 0.3, 0.3],
            effect_weights: [0.3, 0.3, 0.5, 0.2, 0.2, 0.1, 0.2, 0.1, 0.1, 1.5, 0.3, 0.2, 0.1, 0.1, 0.1, 0.1, 0.2,
                             0.3, 3.0, 0.5, 0.3, 0.3, 1.0, 2.0],
            second_effect_chance: 0.25,
            area_chance: 0.1,
            trigger: [0.3, 0.3, 0.3, 0.5, 0.5, 3.0],
        },
        "diplomat" | "ambassador" | "emissary" | "negotiator" => ArchetypeProfile {
            passive_chance: 0.4,
            targeting: [1.5, 1.5, 2.0, 1.0, 0.5, 0.3],
            range: [3.0, 6.0],
            cooldown: [10000, 25000],
            hint: [0.3, 0.5, 0.5, 4.0, 0.5],
            delivery: [3.0, 0.5, 0.5, 1.0, 0.5, 0.3, 0.3],
            effect_weights: [0.3, 0.5, 0.5, 1.0, 0.3, 0.5, 0.5, 0.2, 0.2, 2.0, 1.5, 0.2, 0.3, 0.1, 0.1, 0.1, 0.5,
                             0.3, 0.5, 1.0, 0.5, 3.0, 1.5, 2.0],
            second_effect_chance: 0.4,
            area_chance: 0.25,
            trigger: [0.5, 0.5, 0.3, 1.0, 0.5, 2.0],
        },
        "commander" | "general" | "captain" | "leader" | "warden" => ArchetypeProfile {
            passive_chance: 0.35,
            targeting: [2.0, 2.0, 1.5, 2.0, 0.5, 0.5],
            range: [3.0, 6.0],
            cooldown: [8000, 20000],
            hint: [1.0, 1.0, 1.5, 3.0, 0.5],
            delivery: [3.0, 0.5, 1.0, 1.0, 0.5, 0.3, 0.5],
            effect_weights: [1.5, 0.5, 1.5, 1.0, 0.3, 0.3, 0.5, 0.5, 0.5, 3.0, 0.5, 0.5, 0.3, 0.2, 0.2, 0.2, 0.5,
                             0.5, 0.3, 0.5, 0.5, 0.5, 1.5, 3.0],
            second_effect_chance: 0.45,
            area_chance: 0.4,
            trigger: [1.0, 1.5, 0.5, 1.0, 1.0, 1.0],
        },
        "builder" | "architect" | "mason" | "engineer" => ArchetypeProfile {
            passive_chance: 0.5,
            targeting: [0.5, 1.0, 3.0, 1.0, 0.5, 0.3],
            range: [2.0, 5.0],
            cooldown: [10000, 25000],
            hint: [0.3, 0.5, 2.0, 3.0, 0.3],
            delivery: [3.0, 0.3, 0.5, 1.0, 0.3, 0.5, 0.3],
            effect_weights: [0.3, 0.3, 2.0, 0.2, 0.5, 0.1, 0.2, 0.3, 0.1, 2.0, 0.3, 0.3, 0.1, 0.1, 0.1, 0.1, 0.3,
                             0.3, 2.0, 0.3, 0.3, 0.3, 2.0, 1.5],
            second_effect_chance: 0.3,
            area_chance: 0.3,
            trigger: [0.5, 0.5, 0.3, 1.0, 0.5, 2.0],
        },
        "navigator" | "explorer" | "seafarer" | "cartographer" => ArchetypeProfile {
            passive_chance: 0.35,
            targeting: [2.0, 0.5, 2.0, 0.5, 1.0, 1.0],
            range: [4.0, 7.0],
            cooldown: [6000, 15000],
            hint: [1.0, 0.5, 0.3, 3.0, 0.3],
            delivery: [2.0, 1.0, 0.5, 0.5, 0.3, 1.0, 0.5],
            effect_weights: [1.0, 0.3, 0.5, 0.3, 0.3, 0.2, 0.5, 0.3, 3.0, 1.0, 0.3, 0.2, 1.5, 0.3, 0.1, 0.1, 0.5,
                             3.0, 0.5, 0.3, 2.0, 0.3, 0.3, 0.5],
            second_effect_chance: 0.35,
            area_chance: 0.2,
            trigger: [2.0, 0.5, 1.5, 1.0, 0.5, 1.0],
        },
