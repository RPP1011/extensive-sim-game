...
pub(crate) fn score_spawn_quality(nav: &NavGrid, positions: &[SimVec2]) -> f32 {
...
pub(crate) fn find_nearest_walkable(nav: &NavGrid, x: f32, y: f32) -> SimVec2 {
...
/// the scenario's room layout.  Delegates to [`super::combat_setup::build_combat`].
pub fn run_scenario_to_state_with_room(
    ...
    let setup = super::combat_setup::build_combat(cfg);
    (setup.sim, setup.squad_ai, setup.grid_nav)
}
