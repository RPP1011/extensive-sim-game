...
- [ ] **Step 3: Write the emitter module**
...
- [ ] **Step 4: Register the module in dsl_compiler's lib.rs**
...
- [ ] **Step 6: Wire xtask compile-dsl to write the emitted lib.rs**
...
- [ ] **Step 7: Run compile-dsl and verify the file is regenerated**
...
- [ ] **Step 1: Write the failing test for emit_schedule**
...
- [ ] **Step 3: Implement emit_schedule.rs**
...
- [ ] **Step 4: Run schedule tests to confirm they pass**
...
- [ ] **Step 5: Implement emit_resident_context.rs**
...
- [ ] **Step 6: Implement the four binding-source-container emitters + binding_sources aggregate**
...
- [ ] **Step 7: Register all emitter modules in dsl_compiler's lib.rs**
...
- [ ] **Step 8: Add gpu_rules_hash to schema_hash.rs**
...
- [ ] **Step 9: Confirm the schema_hash module unit tests still pass**
...
- [ ] **Step 10: Wire xtask compile-dsl to emit all five containers + schedule + binding_sources + .schema_hash**
...
- [ ] **Step 11: Run compile-dsl and verify all infrastructure files land**
...
- [ ] **Step 12: Add the schema-hash baseline test**
...
- [ ] **Step 13: Run baseline test to confirm it passes**
...
- [ ] **Step 1: Write the failing emitter unit test**
...
- [ ] **Step 3: Implement emit_mask_kernel.rs**
...
- [ ] **Step 4: Register module in dsl_compiler/src/lib.rs**
...
- [ ] **Step 6: Wire xtask compile-dsl to write fused_mask + mask_unpack files**
...
- [ ] **Step 7: Run compile-dsl + verify the files land + the schema_hash baseline updates**
